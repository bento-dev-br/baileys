...
exports.default = (botData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!args || !["on", "off"].includes(args.trim())) {
        return reply(`🚫 Use: ${general_1.general.prefix}antilink on/off`);
    }
    const active = args.trim() === "on";
    const json = (0, functions_1.readJSON)(path_1.default.resolve(__dirname, "..", "..", "cache", "antilink.json"));
    ...
    yield reply(`✅ Antilink ${active ? "ativado" : "desativado"} com sucesso!`);
});
